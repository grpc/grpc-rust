...
// code.
pub(crate) static mut envoy__config__core__v3__TypedExtensionConfig_msg_init: ::protobuf::__internal::runtime::MiniTableInitPtr =
  ...
  fn mini_table() -> ::protobuf::__internal::runtime::MiniTablePtr {
    ...
    unsafe {
      ONCE_LOCK.get_or_init(|| {
        super::envoy__config__core__v3__TypedExtensionConfig_msg_init.0 =
            ::protobuf::__internal::runtime::build_mini_table("$1X3");
        ::protobuf::__internal::runtime::link_mini_table(
            super::envoy__config__core__v3__TypedExtensionConfig_msg_init.0, &[<::protobuf_well_known_types::Any as ::protobuf::__internal::runtime::AssociatedMiniTable>::mini_table(),
            ], &[]);
        ::protobuf::__internal::runtime::MiniTableInitPtr(super::envoy__config__core__v3__TypedExtensionConfig_msg_init.0)
      }).0
    }
  }
}
