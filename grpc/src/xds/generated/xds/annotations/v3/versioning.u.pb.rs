...
// code.
pub(crate) static mut xds__annotations__v3__VersioningAnnotation_msg_init: ::protobuf::__internal::runtime::MiniTableInitPtr =
  ...
  fn mini_table() -> ::protobuf::__internal::runtime::MiniTablePtr {
    ...
    unsafe {
      ONCE_LOCK.get_or_init(|| {
        super::xds__annotations__v3__VersioningAnnotation_msg_init.0 =
            ::protobuf::__internal::runtime::build_mini_table("$M1P");
        ::protobuf::__internal::runtime::link_mini_table(
            super::xds__annotations__v3__VersioningAnnotation_msg_init.0, &[], &[]);
        ::protobuf::__internal::runtime::MiniTableInitPtr(super::xds__annotations__v3__VersioningAnnotation_msg_init.0)
      }).0
    }
  }
}
