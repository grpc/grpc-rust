...
pub(crate) struct ClusterResource {
    ...
    /// Parsed A32 circuit-breaking config. Enforcement is wired separately.
...
mod tests {
    use super::*;
    use crate::xds::resource::circuit_breaking::DEFAULT_MAX_REQUESTS;
    use envoy_types::pb::envoy::config::cluster::v3::{
        CircuitBreakers, circuit_breakers::Thresholds, cluster::EdsClusterConfig,
    };
    ...
    fn test_validate_basic() {
        ...
        assert_eq!(
            validated.circuit_breaking.max_requests,
    ...
    #[test]
    fn test_circuit_breaking_max_requests() {
        let cluster = Cluster {
            ...
            circuit_breakers: Some(CircuitBreakers {
                thresholds: vec![Thresholds {
                    ...
                    max_requests: Some(UInt32Value { value: 17 }),
                    ..Default::default()
                }],
                ..Default::default()
            }),
        ...
        let validated = ClusterResource::validate(cluster).unwrap();
        assert_eq!(validated.circuit_breaking.max_requests, 17);
    }
